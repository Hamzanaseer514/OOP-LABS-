...
namespace Tasks_All_.BL
{
    class clockType
    {
        ...
        public void elapsed(int h,int m,int s)
        {
            int total = h * 60 * 60 + m * 60 + s;
            Console.WriteLine("Time elapsed : " + total + "s");
        }

        public void remaining(int h, int m, int s)
        {
            int total = h * 60 * 60 + m * 60 + s;
            total = 86400 - total;
            Console.WriteLine("Remaining Time elapsed : " + total + "s");
        }
